// src/app/api/conversations/[id]/unmatch/route.ts
// CR#1: Unmatch = permanent block for both users
...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  // Archive the conversation AND mark as unmatched (permanent)
  ...
  // Create Pax trigger for the user who unmatched
